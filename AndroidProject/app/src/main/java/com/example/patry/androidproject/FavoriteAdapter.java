...
public class FavoriteAdapter extends ArrayAdapter<FavoriteItem> implements View.OnClickListener {
    ...
    public FavoriteAdapter(ArrayList<FavoriteItem> data, Context context) {
    ...
    public void onClick(View v) {
        ...
        FavoriteItem dataModel=(FavoriteItem) object;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FavoriteItem dataModel = getItem(position);
