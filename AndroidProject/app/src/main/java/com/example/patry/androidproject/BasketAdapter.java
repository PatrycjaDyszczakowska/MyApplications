...
public class BasketAdapter extends ArrayAdapter<FavoriteItem> implements View.OnClickListener {
    ...
    public BasketAdapter(ArrayList<FavoriteItem> data, Context context) {
