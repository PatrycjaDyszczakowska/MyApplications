...
public class SearchAdapter extends ArrayAdapter<SearchItem> implements View.OnClickListener {
    ...
    public SearchAdapter(ArrayList<SearchItem> data, Context context) {
    ...
    public void onClick(View v) {
        ...
        SearchItem dataModel=(SearchItem) object;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SearchItem dataModel = getItem(position);
